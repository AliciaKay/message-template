...
class Modal extends Component {
    ...
    writeCustom(guest, template, company) {
        ...
        jsx.push(
            <div>
            <textarea class="form-control" id="formControlTextarea" rows="3" defaultValue={template.greeting+" "+guest.firstName+template.welcome+" "+company+template.room+" "+template.signOff}></textarea>
            ...
            <div className="modal-dialog">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title" id={"templateModalLabel"+guest.id}>Draft your message</h5>
                        <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div className="modal-body">
                   {this.state.selectedCustom ? this.writeCustom(guest, template, company) : this.makeStandard(guest, template, company)}
                    </div>
